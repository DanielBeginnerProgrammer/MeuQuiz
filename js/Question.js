class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta: - Qual nome você acha o mais bonito? " );
    this.question.position(150, 80);
    this.option1.html("1: ANATÉCIA " );
    this.option1.position(150, 100);
    this.option2.html("2: DANIEL" );
    this.option2.position(150, 120);
    this.option3.html("3: DIOGO" );
    this.option3.position(150, 140);
    this.option4.html("4: CAMILA" );
